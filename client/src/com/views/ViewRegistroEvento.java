...
public class ViewRegistroEvento extends JFrame {
	...
	public ViewRegistroEvento() {
		...
		selectTipo = new JComboBox<EnumEventoTipo>();
		...
		gbc_lblModalidad.gridy = 9;
		panel.add(lblModalidad, gbc_lblModalidad);
		
		selectModalidad = new JComboBox<EnumEventoModalidad>();
		...
		gbc_inputLocalizacion.gridy = 14;
	...
	private void cargarItr() {
		// TODO Traer los datos del servidor y completar el Combobox con los mismos
		
	}

	private void cargarEventoModalidad() {
		// TODO Traer los datos del servidor y completar el Combobox con los mismos
		
	}

	private void cargarEventoTipo() {
		// TODO Traer los datos del servidor y completar el Combobox con los mismos
